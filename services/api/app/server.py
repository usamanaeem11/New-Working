...
# NEW FEATURES - Phase 9 (January 2026)
from routes.client_portal import router as client_portal_router
from routes.resource_planning import router as resource_planning_router
from routes.workflow_engine import router as workflow_router
from routes.business_intelligence import router as bi_router
from routes.wellness import router as wellness_router
from routes.performance_reviews import router as performance_router
...
api_router.include_router(resource_planning_router)
